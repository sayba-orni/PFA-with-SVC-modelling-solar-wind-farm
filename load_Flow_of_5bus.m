...
while error>=tol
    ...
    Correction(5:8)= Correction(5:8).*V_abs(2:5);
    V_abs(2:5) = V_abs(2:5) + Correction(5:8);
    V_angle(2:5) = V_angle(2:5) + Correction(1:4);

    num_of_it=num_of_it+1;
    error=abs(max(Mismatch));
